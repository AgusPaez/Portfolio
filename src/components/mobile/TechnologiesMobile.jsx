...
const TechnologiesMobile = () => {
  return (
    <>
      <section id="tecnologias" className=" border-t-2 backdrop-brightness-125">
        <div className="bg-green-400 absolute w-full h-[3rem] invisible top-170">
          {" "}
          aaa
        </div>
        <div
          id="tecnologias"
          className="text-gray-800 pb-8 pt-[50px]  text-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 lg:pr-20 border-b-[1.5px] border-[#ffffff]"
        >
          <motion.div
      ...
      >
        <div className="text-gray-800 pb-20 pt-[50px] text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-10 lg:pr-20 ">
          ...
          >
            <a className="border-[0.5px] shadow border-gray-300 bg-gradient-to-br from-[#efefef] via-[#ffffff] to-[#efefef] py-0.5 px-4 rounded-2xl dark:bg-gradient-to-br dark:from-[#364050] dark:via-[#3a4455] dark:to-[#364050] dark:border-gray-700 dark:text-[#EAEAEA]">
              Herramientas
            </a>
          </motion.div>
