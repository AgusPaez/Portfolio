...
const Experience = () => {
  return (
    ...
    >
      ...
      <motion.div
        className="relative brightness-105 hover:brightness-105 bg-gradient-to-br from-[#e9e9fc] via-[#ededfd] to-[#e9e9fc] grid rounded-2xl shadow-lg text-left h-[28rem] border border-white overflow-hidden"
        initial={{
          opacity: 0,
          y: 50,
        }}
      ...
      >
        <div className="w-[100%] h-full items-center">
          <div className="h-[16%]">
            <h1 className="text-3xl font-bold text-center mb-3 text-gray-900 mt-5">
              Suinfi
            </h1>
          </div>
        ...
        <div className="w-[100%]  mt-1 mb-10 text-center text-gray-600 text-sm">
